  ...
  (
    ...
    const getResizeHandleAt = useCallback(
      (
        ...
        const handles = [
          {
            name: "nw",
            x: selection.x - HANDLE_SIZE / 2,
            y: selection.y - HANDLE_SIZE / 2,
          },
          {
            name: "ne",
            x: selection.x + selection.width - HANDLE_SIZE / 2,
            y: selection.y - HANDLE_SIZE / 2,
          },
          {
            name: "sw",
            x: selection.x - HANDLE_SIZE / 2,
            y: selection.y + selection.height - HANDLE_SIZE / 2,
          },
          {
            name: "se",
            x: selection.x + selection.width - HANDLE_SIZE / 2,
          ...
          {
            name: "n",
            x: selection.x + selection.width / 2 - HANDLE_SIZE / 2,
            y: selection.y - HANDLE_SIZE / 2,
          },
          {
            name: "s",
          ...
          },
          {
            name: "w",
            x: selection.x - HANDLE_SIZE / 2,
            y: selection.y + selection.height / 2 - HANDLE_SIZE / 2,
          },
          {
            name: "e",
            x: selection.x + selection.width - HANDLE_SIZE / 2,
    ...
    const drawSelection = useCallback(
      (
        ...
        // Selection rectangle
        ctx.strokeStyle = isCurrentSelection
          ? "#ef4444"
          : isSelected
          ? "#3b82f6"
          : "#6b7280";
        ...
        if (isSelected || isCurrentSelection) {
          ctx.fillStyle = isCurrentSelection
            ? "rgba(239, 68, 68, 0.1)"
            : "rgba(59, 130, 246, 0.1)";
          ctx.fillRect(
            selection.x,
